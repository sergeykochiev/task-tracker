...
export type DiscordRegisterCommandInteraction = DiscordCommandInteractionWithOptions<[APIApplicationCommandInteractionDataStringOption, APIApplicationCommandInteractionDataRoleOption]>
