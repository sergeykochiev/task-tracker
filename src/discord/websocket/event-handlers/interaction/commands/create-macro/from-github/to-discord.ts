...
export default async function discordhandleCreateMacroFromGithubToDiscordCommand(data: APIApplicationCommandInteraction) {
    ...
    //                         custom_id: "create-macro_github_discord_event",
    //                         max_values: 1,
    //                         min_values: 1,
